...
use DBI;
unshift(@INC, '/usr/lib/perl5/site_perl/5.8/Win32');
use lib "/usr/lib/perl5/site_perl/5.8/Win32";
use Win32::OLE;
#use Win32OLE;
...
my $dbh = DBI->connect(q{dbi:ODBC:driver=Microsoft Access Driver (*.mdb); +dbq=C:\Program Files\Trading Partner\System\Recon.mdb}, '', '');
